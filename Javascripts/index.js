...
async function completar () {
    ...
    if(arrayContactos == false) {
        document.getElementById("tabla").style = "display: none"
        let sector = document.getElementById("sector-2")
        let img = document.createElement("img")
        img.src = "../assets/icon-busqueda-sin-resultado.svg"
        img.style = "width: 25%; margin-left: 511px;"
        let p = document.createElement("p")
        p.innerHTML = "¡Crea tu primer CONTACTO para que se muestre aquí!"
        p.style = "font-size: 18px; color: #50E3C2;text-align: center; line-height: 33px; font-weight: 600;"
